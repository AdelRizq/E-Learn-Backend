...
CREATE TABLE `course_activities` (
  ...
  KEY `CA_activity_id` (`activity_id`),
  CONSTRAINT `CA_activity_id` FOREIGN KEY (`activity_id`) REFERENCES `activity` (`id`),
  CONSTRAINT `CA_course_id` FOREIGN KEY (`course_id`) REFERENCES `course` (`id`)
